...
import 'page07_model.dart';
export 'page07_model.dart';

class Page07Widget extends StatefulWidget {
  const Page07Widget({
    super.key,
  ...
  @override
  State<Page07Widget> createState() => _Page07WidgetState();
}

class _Page07WidgetState extends State<Page07Widget> {
  late Page07Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Page07Model());
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await widget.projectdocref!
                                ...
                                imagesconfusionMatrix: getJsonField(
                                  (_model.apiResulteq9?.jsonBody ?? ''),
                                  r'''$.insights_images.summary_stats''',
                                ).toString(),
                                imagesmetricsBarplot: getJsonField(
                                  (_model.apiResulteq9?.jsonBody ?? ''),
                                  r'''$.images.metrics_barplot''',
                                ).toString(),
                                imagesperformanceMetrics: getJsonField(
                                  (_model.apiResulteq9?.jsonBody ?? ''),
                                  r'''$.images.performance_metrics''',
                                ).toString(),
                              ));
